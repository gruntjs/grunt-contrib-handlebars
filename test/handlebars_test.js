...
exports.handlebars = {
  ...
  amd_compile_handlebars_path: function(test) {
    test.expect(1);

    filesAreEqual('amd_compile_handlebars_path.js', function(actual, expected) {
      test.equal(actual, expected, 'should wrap everything with an AMD define block and use a custom path to handlebars.');
      test.done();
    });
  },
